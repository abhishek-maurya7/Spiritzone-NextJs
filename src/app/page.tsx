        ...
        <div className="container mt-5">
            ...
            <div className="row justify-content-center">
                <div className="col-md-8">
                    <table className="table table-primary" style={{ borderRadius: "20px", overflow: "hidden" }}>
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Price</th>
                        ...
                        <tfoot>
                            <tr>
                                <td>Total:</td>
                                <td>${cart.reduce((acc, curr) => acc + curr.price, 0)}</td>
                                <td>
                                    <button className="btn btn-success" onClick={()=>{window.location.href = '/success'}}>Place Order</button>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
                        ...
                        <div className="card h-100">
                            ...
                            <div className="card-footer">
                                <div className="d-flex justify-content-between align-items-center">
                                    ...
                                    <button onClick={() => handleAddCart(dish)} className="btn btn-primary">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
